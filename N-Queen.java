...
public class NQueensVisualizer extends JPanel {
    private int[] queens;
    private int n;
    private static final int CELL_SIZE = 80; // ell size
    private static final int DELAY = 350; // Delay in milliseconds
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color lightColor = new Color(255, 255, 255); // Cream color
        Color darkColor = new Color(0, 0, 0); // Dark brown color
        Color queenColor = new Color(220, 202, 15); // Dark white (light gray) for queen
